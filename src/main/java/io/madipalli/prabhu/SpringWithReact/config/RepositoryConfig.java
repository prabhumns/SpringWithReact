 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"io.madipalli.prabhu.SpringWithReact.dal.sql"})
@EnableMongoRepositories(basePackages = {"io.madipalli.prabhu.SpringWithReact.dal.mongo"})
