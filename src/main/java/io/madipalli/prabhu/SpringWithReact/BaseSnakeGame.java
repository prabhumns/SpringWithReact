...
abstract class BaseSnakeGame implements SnakeGame {
    ...
    public void nextInstant() {
        ...
        if (this.board[this.head.x][this.head.y] != null && this.board[this.head.x][this.head.y].isSnakeBody()) {
    ...
    private void moveSnakeHead() {
        ...
        final var newHead = new SnakeBodySection(this.cleanCoordinate(x), this.cleanCoordinate(y));
