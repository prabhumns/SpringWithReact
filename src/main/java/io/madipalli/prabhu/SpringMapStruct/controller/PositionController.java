...
public class PositionController {
    ...
    public PositionResponse createPosition(@RequestBody final CreatePositionRequest positionRequest) {
        return PositionMapper.INSTANCE.convertPositionEntityToPositionResponse(positionService.createPosition(positionRequest.getName()));
    }

    @GetMapping("/{positionId}")
    @ResponseStatus(HttpStatus.OK)
    public PositionResponse findSinglePositionWithPositionId(@PathVariable final String positionId){
        final var bo = positionService.findPositionById(positionId);
        return PositionMapper.INSTANCE.convertPositionEntityToPositionResponse(bo);
    }
    ...
    public List<PositionResponse> findAllPositions(){
        ...
        return PositionMapper.INSTANCE.convertPositionEntityToPositionResponse(bos);
    }
}
